...
>
> No account needed to browse. Sign in to confirm whether a project is still accepting investors, or add a project the community is missing. Your contributions show up on **My Timeline**.
>
...
> 2. Signing in as an RC representative to verify and claim/edit your projects (or emailing me corrections)
>
> Feedback: feedback@eb5base.com
>
> Thanks,
> Ashok
...
|--------|----------------|
| Traffic | GoatCounter dashboard |
| Sign-ins | Supabase Auth users |
| Confirmations | `project_votes` table or My Timeline |
| Feedback | feedback@eb5base.com inbox |

Triage feedback: **data wrong** → fix listing; **bug** → fix + reply; **feature** → park for v1.1.
