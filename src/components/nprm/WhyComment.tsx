...
import GlossaryTerm, { GlossaryText } from '@/components/nprm/GlossaryTerm';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="rounded-xl border border-base-300 bg-base-100 p-4 space-y-2 scroll-mt-28"
      >
        <NprmSectionHeading
          as="h3"
          eyebrow="Impact"
        ...
        <p className="text-sm text-neutral leading-relaxed">
          ...
          consider significant comments. A <GlossaryTerm term="GAO" /> survey
          found most program offices reported that comments led to substantive
          changes in final rules. The Office of the Federal Register says
          persuasive comments can change a proposal. In the last major EB-5
          modernization (2019), <GlossaryTerm term="DHS" /> answered hundreds of
          comments and lowered the proposed <GlossaryTerm term="TEA" /> investment
          amount from $1.35M to $900K. Unique investor stories help put concrete
          harms on the record so they must be addressed, especially if other
          voices push only to tighten the program.
        </p>
