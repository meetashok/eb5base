  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-neutral leading-relaxed">
        Agencies publish a draft, you submit a comment on regulations.gov with
        docket{' '}
        <a
          href={DOCKET_URL}
          target="_blank"
        ...
        explaining your concern, data, and a better approach if you have one.
        The agency reads all comments before issuing a final rule. A clear
        personal experience with specific section numbers is useful.
      </p>
