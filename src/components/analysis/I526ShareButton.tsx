...
function payloadKey(payload: I526SharePayload): string {
...
async function mintShortShareUrl(payload: I526SharePayload): Promise<string | null> {
  try {
    const res = await fetch('/api/analysis/i526/share', {
      method: 'POST',
