      ...
      <div className="rounded-xl border-2 border-base-300 bg-base-100 p-4 sm:p-5 text-sm text-neutral leading-relaxed space-y-2">
        ...
        <ul className="list-disc pl-5 space-y-1.5">
          <li>
            ...
            exclude consular cases at the Department of State and anyone who has not filed an I-485
            yet.
          </li>
          <li>
            A cohort shrinking between snapshots usually means cases completed, but USCIS does not
            publish adjudications in this report, so new filings and completions are mixed together
            in the monthly change.
          </li>
          <li>
            Values under 10 are suppressed by USCIS (shown as &quot;D&quot; in the source files). We
            exclude them from totals and note how many are hidden in your selection.
          </li>
          <li>
