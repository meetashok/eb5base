      ...
      <div className="space-y-10">
        ...
        <Section title="What is public vs. private">
          ...
          <p>
            ...
            activity, your display name, role, project submissions, edits, confirmations, and other
            community contributions may be visible to other users as part of the directory.
          </p>
          <p>
